...
>  - In the label configuration, permissions should be assignd to any authenticated user or all users in your organaizetion for Defender for cloud apps to be able to read label information. 
